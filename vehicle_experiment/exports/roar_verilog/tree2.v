module tree2 (
	...
	always @(posedge clock) begin
		if (IEEE754_comparator(32'b01000011001001101000000000000000, feature3)) begin
			if (IEEE754_comparator(32'b01000011001001011000000000000000, feature10)) begin
				if (IEEE754_comparator(32'b01000010101101010000000000000000, feature0)) begin
					voted_class <= class3;
				end 
				else begin
					voted_class <= class0;
				...
				if (IEEE754_comparator(32'b01000001000010000000000000000000, feature5)) begin
					voted_class <= class2;
				end 
				else begin
					voted_class <= class0;
			...
			if (IEEE754_comparator(32'b01000011001011001000000000000000, feature9)) begin
				if (IEEE754_comparator(32'b01000010100110110000000000000000, feature2)) begin
					voted_class <= class2;
				end 
				else begin
					voted_class <= class1;
				...
				if (IEEE754_comparator(32'b01000011001111000000000000000000, feature17)) begin
					voted_class <= class2;
				end 
				else begin
					voted_class <= class3;
