...
/*
 * Retorna a última classificação produzida pelo acelerador.
 *
 * CUSTOM-0:
 *   funct3 = 000
 *   rd     = a0
...
int main(void) {
    ...
    /*
     * A memória das árvores precisa ser carregada apenas uma vez.
     */
    ...
    while (1) {
        ...
        /*
         * Final da passagem pelas 169 amostras.
         */
        show_separator();

        /*
         * Existem somente quatro LEDs, então o valor 169 não
         * pode ser mostrado integralmente.
         *
         * Mostramos os quatro bits inferiores:
         *
         *   169 decimal = 0xA9
         *   quatro bits inferiores = 0x9
         *
         * Se houver equivalência 169/169, aparece 1001.
         */
        show_led_value(
        ...
        /*
         * 107 decimal = 0x6B.
         * Os quatro bits inferiores são 0xB = 1011.
         */
        show_led_value(
            label_matches & 0xFu,
            1200000u
        ...
        /*
         * Mostra os quatro bits inferiores da quantidade de
         * ciclos da última inferência.
         */
        show_led_value(
            last_cycles & 0xFu,
            1200000u
