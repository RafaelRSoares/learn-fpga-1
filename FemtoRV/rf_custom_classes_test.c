...
static void show_class(uint32_t c) {
    LEDS(1 << (c & 3));
...
int main() {
    ...
    while(1) {
        show_class(rf_classify(10, 0, 0, 0));
        show_class(rf_classify(30, 0, 0, 0));
        show_class(rf_classify(60, 0, 0, 0));
        show_class(rf_classify(90, 0, 0, 0));
