...
HD_PWD='C:/Users/rafas/learn-fpga/learn-fpga/FemtoRV/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log femtosoc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source femtosoc.tcl
