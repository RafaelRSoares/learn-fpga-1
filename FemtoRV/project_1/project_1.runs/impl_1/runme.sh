...
HD_PWD='C:/Users/rafas/learn-fpga/learn-fpga/FemtoRV/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log femtosoc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source femtosoc.tcl -notrace
