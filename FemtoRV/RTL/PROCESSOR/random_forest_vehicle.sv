...
module random_forest_vehicle(
    ...
    // Indexed feature input
    input [4:0] feature_addr,
    input [31:0] feature_data_in,
    input feature_we,
    ...
    // Tree node structure: [feature_idx(5b), threshold_x2(11b), class(8b), reserved(8b)]]
    reg [31:0] tree_memory [TREE_COUNT * NODES_PER_TREE - 1:0];
    
    // Internal signals
    reg [31:0] features [17:0];
    ...
    always @(posedge clk) begin
        if (feature_we) begin
            features[feature_addr] <= feature_data_in;
        end
    end
    ...
    task traverse_tree;
        ...
        integer node_id, current_node;
        reg [4:0] feature_idx;
        reg [10:0] threshold_x2;
        reg [31:0] node_data, feature_val_x2;
        ...
        begin
            ...
            repeat (DEPTH) begin
                ...
                // Decode node: [feature_idx(5b), threshold_x2(11b), class(8b), reserved(8b)]
                feature_idx = node_data[31:27];
                threshold_x2 = node_data[26:16];
                
                // Get feature value
                feature_val_x2 = features[feature_idx];
                
                // Decide left or right
                if (feature_val_x2 <= {21'd0, threshold_x2}) begin
