module tree0 (
	...
	always @(posedge clock) begin
		if (IEEE754_comparator(32'b01000011101111110000000000000000, feature11)) begin
			if (IEEE754_comparator(32'b01000001000010000000000000000000, feature5)) begin
				if (IEEE754_comparator(32'b01000010001001100000000000000000, feature1)) begin
					voted_class <= class0;
				end 
				else begin
					voted_class <= class2;
				...
				if (IEEE754_comparator(32'b01000011000000010000000000000000, feature3)) begin
					voted_class <= class0;
				end 
				else begin
					voted_class <= class0;
			...
			if (IEEE754_comparator(32'b01000000111100000000000000000000, feature5)) begin
				if (IEEE754_comparator(32'b01000000110100000000000000000000, feature5)) begin
					voted_class <= class2;
				end 
				else begin
					voted_class <= class2;
