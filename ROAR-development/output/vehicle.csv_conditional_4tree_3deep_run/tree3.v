module tree3 (
	...
	always @(posedge clock) begin
		if (IEEE754_comparator(32'b01000001100101000000000000000000, feature8)) begin
			if (IEEE754_comparator(32'b01000010101000110000000000000000, feature0)) begin
				voted_class <= class3;
			end 
			else begin
				if (IEEE754_comparator(32'b01000001100111000000000000000000, feature15)) begin
					voted_class <= class0;
				end 
				else begin
					voted_class <= class1;
			...
			if (IEEE754_comparator(32'b01000011001111101000000000000000, feature17)) begin
